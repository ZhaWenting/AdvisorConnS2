...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ChatAdapter(Context context, Activity activity, ClickTextListener clickTextListener, LinkedTextListener linkedTextListener) {
    ...
    public ChatAdapter(Context context, ArrayList<Season2ChatBean> list, Activity activity, ClickTextListener clickTextListener, LinkedTextListener linkedTextListener) {
        this.context = context;
        this.list = list;
        this.activity = activity;
        this.clickTextListener = clickTextListener;
