 ...
 * @date 2015年11月4日
 */
public class SystemParamsS2Virus {

	private static SystemParamsS2Virus instance;
	private static SharedPreferences sharedPrederences = null;

	private SystemParamsS2Virus() {
	}

	//在Application初始化
	public static void init(Context context) {
		sharedPrederences = context.getSharedPreferences(Contants.SAVES2VIRUS, Context.MODE_PRIVATE);
	}
	public static SystemParamsS2Virus getInstance() {
		
		if(instance == null) {
			synchronized (SystemParamsS2Virus.class) {
				if(instance == null) {
					 instance = new SystemParamsS2Virus();
				}
			}
		}
		return instance;
